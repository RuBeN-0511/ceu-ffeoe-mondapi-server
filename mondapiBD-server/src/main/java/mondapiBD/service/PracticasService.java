...
public interface PracticasService {
    ...
    /**
     * Registra fechas laborables excluyendo sábados y domingos.
     * Lanza error si ya existen fechas para ese curso/evaluación.
    ...
    // Diario de Prácticas
    /**
     * Valida: solo un registro por alumno/fecha.
     * Horas entre 0 y 8 con saltos de 0.5.
     * @throws ConflictException 
